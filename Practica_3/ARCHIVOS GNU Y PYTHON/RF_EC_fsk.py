...
import RF_EC_fsk_epy_block_0 as epy_block_0  # embedded python block
import RF_EC_fsk_epy_block_0_0 as epy_block_0_0  # embedded python block
import RF_EC_fsk_epy_block_0_1 as epy_block_0_1  # embedded python block
import math
import numpy as np
import sip
...
class RF_EC_fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RF_EC_fsk")
...
def main(top_block_cls=RF_EC_fsk, options=None):
