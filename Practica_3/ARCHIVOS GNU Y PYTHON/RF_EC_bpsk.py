...
import RF_EC_bpsk_epy_block_0 as epy_block_0  # embedded python block
import RF_EC_bpsk_epy_block_0_0 as epy_block_0_0  # embedded python block
import math
import numpy as np
import sip
...
class RF_EC_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RF_EC_bpsk")
...
def main(top_block_cls=RF_EC_bpsk, options=None):
